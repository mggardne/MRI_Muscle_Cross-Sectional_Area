...
%ROI_MOV   Gets data from the ROI listener MovingROI to allow movements
%          of vertices, but block movements of the whole ROI.
%
...
%
%          NOTES:  1.  See M-file musc_threshr.m for more information.
%
